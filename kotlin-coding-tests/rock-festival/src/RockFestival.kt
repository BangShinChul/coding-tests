 ...
 * 전체 밴드를 몇 팀 섭외할지는 아직 결정하지 않았지만, 페스티벌의 간판 스타인 L개의 팀은 이미 섭외가 끝난 상태입니다.
 ...
 * 이때 하루 평균 (1+2+3)/3 = 2 의 비용이 듭니다.
 * 반면 2일째부터 5일째까지 공연장을 대여하면 평균 비용이 (1+2+3+1)/4 = 7/4 밖에 되지 않습니다.
 *
 *
 * 시간 및 메모리 제한 :
 ...
 * 이미 섭외한 공연팀의 수 L(1 ≤ L ≤ 1000, L ≤ N)이 주어집니다.
 * 그 다음 줄에는 N개의 숫자로 공연장 대여 비용이 날짜별로 주어집니다.
 * 모든 비용은 100 이하의 자연수입니다.
 *
 * 출력 :
 * 입력에 주어지는 각 테스트 케이스마다 한 줄에 최소의 평균 대여 비용을 출력합니다.
 * 10⁻⁷ 이하의 절대/상대 오차가 있는 답은 정답 처리됩니다.
 *
 * 예제 입력 :
 * 2
 * 6 3
...
/**
 * 문제 풀이 시작 시간 : yyyy-MM-dd 00:00:00
 * 문제 풀이 종료 시간 : yyyy-MM-dd 00:00:00
 *
